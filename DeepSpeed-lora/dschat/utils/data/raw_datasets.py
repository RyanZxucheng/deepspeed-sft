...
# Chinese dataset
class FreedomIntelligenceMedicalChineseDataset(PromptRawDataset):

    def __init__(self, output_path, seed, local_rank, dataset_name):
        super().__init__(output_path, seed, local_rank, dataset_name)
        self.dataset_name = "FreedomIntelligence/Medical-R1-Distill-Data-Chinese"
        self.dataset_name_clean = "FreedomIntelligence_Medical_R1_Distill_Data_Chinese"
    ...
    def get_chosen(self, sample):
        if sample['response (content)'] is not None:
    ...
    def get_prompt_and_chosen(self, sample):
        if sample['question'] is not None and sample['response (content)'] is not None:
            return " Human: " + sample['question'] + " Assistant: " + sample[
                'response (content)']
        return None
    ...
    def get_prompt_and_rejected(self, sample):
        ...
        return None
# Chinese dataset
class krisfuMedicalChineseDataset(PromptRawDataset):

    def __init__(self, output_path, seed, local_rank, dataset_name):
        super().__init__(output_path, seed, local_rank, dataset_name)
        self.dataset_name = "krisfu/delicate_medical_r1_data_chinese"
        self.dataset_name_clean = "krisfu_delicate_medical_r1_data_chinese"
    ...
    def get_prompt_and_chosen(self, sample):
        if sample['question'] is not None and sample['answer'] is not None:
            return " Human: " + sample['question'] + " Assistant: " + sample[
                'answer']
        return None
