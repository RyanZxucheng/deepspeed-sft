...
def get_raw_dataset(dataset_name, output_path, seed, local_rank):
    ...
    elif "FreedomIntelligence/Medical-R1-Distill-Data-Chinese" in dataset_name:
        return raw_datasets.FreedomIntelligenceMedicalChineseDataset(
            output_path, seed, local_rank, dataset_name)
    elif "krisfu/delicate_medical_r1_data_chinese" in dataset_name:
        return raw_datasets.krisfuMedicalChineseDataset(
            output_path, seed, local_rank, dataset_name)
    else:
        raise RuntimeError(
